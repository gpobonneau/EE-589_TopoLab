...
%% PREPROCESSING DATA
% read files
ms010msp010_ati = readmatrix('raw_data/MS010MPT010_NIDAQ USB-6210_31683603.csv');
ms010msp010_ati(:, 4:end) = Gamma_volt_to_load(ms010msp010_ati); %convert from voltages to loads
ms010msp010_ati = ms010msp010_ati(:, 4:6);

figure;
plot(rms(ms010msp010_ati, 2));
TE = 1/120;
start = 7200;
...
for i = 1:5
    pos = start+(i-1)*35/TE;
    ms010msp_thrust(:,:,i) = [ms010msp010_ati(pos+3/TE:pos+8/TE, :); ms010msp010_ati(pos+18/TE:pos+23/TE, :)];
    ms010msp_calib(:,:, i) = [ms010msp010_ati(pos+12/TE:pos+13/TE, :); ms010msp010_ati(pos+27/TE:pos+33/TE, :)];
